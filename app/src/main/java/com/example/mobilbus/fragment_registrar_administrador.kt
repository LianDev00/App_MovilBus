...
class RegistrarAdministradorFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.fragment_registrar_administrador, container, false)
        ...
        btnGuardar.setOnClickListener {
            ...
            Toast.makeText(requireContext(), "Guardando administrador: $nombres $apellidos $dni $usuario $contrasena", Toast.LENGTH_SHORT).show()
        }
