...
class BuscarAdministradorFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.fragment_buscar_administrador, container, false)
        ...
        btnGuardarBuscar.setOnClickListener {
            ...
            Toast.makeText(requireContext(), "Guardando cambios para administrador con DNI: $dni", Toast.LENGTH_SHORT).show()
        }

        btnEliminar.setOnClickListener {
            val dni = inputDNIBuscar.text.toString()
            Toast.makeText(requireContext(), "Eliminando administrador con DNI: $dni", Toast.LENGTH_SHORT).show()
