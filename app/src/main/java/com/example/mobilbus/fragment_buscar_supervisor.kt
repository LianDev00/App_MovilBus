...
class BuscarSupervisorFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.fragment_buscar_supervisor, container, false)
        ...
        btnGuardarBuscar.setOnClickListener {
            ...
            Toast.makeText(requireContext(), "Guardando cambios para supervisor con DNI: $dni", Toast.LENGTH_SHORT).show()
        }

        btnEliminar.setOnClickListener {
            val dni = inputDNIBuscar.text.toString()
            Toast.makeText(requireContext(), "Eliminando supervisor con DNI: $dni", Toast.LENGTH_SHORT).show()
