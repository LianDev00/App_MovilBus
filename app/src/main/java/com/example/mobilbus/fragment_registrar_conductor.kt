...
class RegistrarConductorFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.fragment_registrar_conductor, container, false)
        ...
        btnGuardar.setOnClickListener {
            ...
            Toast.makeText(requireContext(), "Guardando conductor: $nombres $apellidos $dni $usuario $contrasena", Toast.LENGTH_SHORT).show()
        }
